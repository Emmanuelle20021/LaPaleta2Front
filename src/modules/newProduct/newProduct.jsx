...
function Categories(categories) {
    ...
    categories.forEach((element) => {
        options.push(<option value={element.idcategoria} id={'option-' + element.id} key={'option-' + element.id}>{element.nombre}</option>)
    })
    return (options)
}
...
function Subcategories(subcategories) {
    ...
    subcategories.forEach((element) => {
        options.push(<option value={element.idsubcategoria} id={'option-subcategory-' + element.id} key={'option-subcategory-' + element.id}>{element.nombre}</option>)
    })
    return (options)
}